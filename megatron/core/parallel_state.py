...
def initialize_model_parallel(
    ...
    Arguments:
        tensor_model_parallel_size (int, default = 1): 张量并行的维度
            The number of GPUs to split individual tensors across.

        pipeline_model_parallel_size (int, default = 1): 流水线并行的维度
        ...
        virtual_pipeline_model_parallel_size (int, optional): 流水级数
        ...
        pipeline_model_parallel_split_rank (int, optional): 流水线序号
        ...
        context_parallel_size (int, default = 1): 序列长度维度
            The number of tensor parallel GPU groups to split the
